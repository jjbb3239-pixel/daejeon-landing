...
| 동구동락 | `donggu-dongrak.jpg` (651×920) | `50% 50%` | 중앙 |
...
> **저해상도 포스터 교체 이력**
> - `유성온날` 174×250 → 뉴시스 보도 이미지 720×973 (푸터 출처에 뉴시스 표기)
> - `동구동락` 443×627 → 한밭대 공지 첨부 2482×3509 → 920 기준으로 저장 (651×920)
>
> 포스터가 뿌옇게 보이면 원본을 더 큰 걸로 구해 같은 경로에 덮어쓰고
> 긴 변 920px · JPEG 88 로 맞추면 된다.
